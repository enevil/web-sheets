...
function useDeepMemo(factory, deps) {
  ...
  if (!valueRef.current) {
    ...
    isValid = !!(deps && valueRef.current.deps && isEqual__default['default'](deps, valueRef.current.deps));
  }
...
var useWidget = function useWidget(_ref3, uploadcare) {
  var id = _ref3.id,
      ...
      options = index._objectWithoutProperties(_ref3, ["id", "name", "value", "onFileSelect", "onChange", "onDialogOpen", "onDialogClose", "onTabChange", "apiRef", "customTabs", "validators", "tabsCss", "locale", "localeTranslations", "localePluralize", "previewUrlCallback"]);
  ...
  return React.useCallback(function () {
    return /*#__PURE__*/React__default['default'].createElement("input", index._extends({
      type: "hidden",
      ref: input,
      id: id,
      name: name
...
var Uploader = function Uploader(props) {
  var Input = useWidget(props, uploadcare__default['default']);
